                                        ...
                                        <div class="card-header">    
                                            ...
                                            <div id="filtros" class="form-row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <a href="/produtos/create"><button id="cadastro"  type="button" class="btn btn-primary" >Cadastro</button></a>
                                                </div>
                                            </div>
                                        </div>             			                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                                        <div class="card-body">                                                                                                     
...
$(function() {
        ...
        { data: 'id_produto', 
                ...
                {
                    return '<a href="produtos/'+row.id_produto+'/edit"><i class="align-middle mr-2 fas fa-fw fa-edit" data-feather="edit-2"></i>Editar </a>\n\
                            <a href="" rowName="'+row.nome_produto+'" rowId="'+row.id_produto+'" class="excluir"><i class="align-middle mr-2 fas fa-fw fa-trash excluir" data-feather="trash"></i>Excluir</a>';
                } 
            }
        ],
...
$("body").on("click", "a.excluir", function (e) {
    ...
    Swal.fire({
        ...
        $.ajax(
        {
            url: "produtos/"+$(this).attr('rowId')+"/destroy",
            type: 'DELETE',
            data: {
                "id": $(this).attr('rowId'),
                "_token": token,
            ...
            success: function (){
                Swal.fire(
                    'Deletado!',
                    'O Produto selecionado foi deletado.',
                    'success'
                )
                $('#table').DataTable().ajax.reload();
            }
