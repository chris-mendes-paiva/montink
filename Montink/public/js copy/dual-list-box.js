...
(function($) {
    ...
    $.fn.DualListBox = function(paramOptions, selected) {
        return this.each(function () {
            var defaults = {
                ...
                warning:    'Tem certeza de que deseja mover muitos itens? Isso pode fazer com que seu navegador pare de responder.'
            };
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).addClass('row').append(
                ...
                '       <h4><!--<span class="unselected-title"></span>--> <small>Total: <span class="unselected-count"></span></small></h4>' +
                '       <input class="filter form-control filter-unselected" type="text" placeholder="Pesquisar" style="margin-bottom: 5px;">' +
                ...
                (options.horizontal == false ? '   <div class="col-md-5">' : '   <div class="col-md-6">') +
                '       <h4><!--<span class="selected-title"></span>--> <small>Total: <span class="selected-count"></span></small></h4>' +
                '       <input class="filter form-control filter-selected" type="text" placeholder="Pesquisar" style="margin-bottom: 5px;">' +
