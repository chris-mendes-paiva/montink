  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '     <button type="button" class="btn btn-light moveall">' +
        '       <i class="align-middle mr-2 fas fa-fw fa-angle-double-right"></i>' +
        '     </button>' +
        '     <button type="button" class="btn btn-light move">' +
        '       <i class="align-middle mr-2 fas fa-fw fa-angle-right"></i>' +
        '     </button>' +
        '   </div>' +
        ...
        '       <i class="align-middle mr-2 fas fa-fw fa-angle-left"></i>' +
        '     </button>' +
        '     <button type="button" class="btn btn-light removeall">' +
        '       <i class="align-middle mr-2 fas fa-fw fa-angle-double-left"></i>' +
        '     </button>' +
        '   </div>' +
        '   <select multiple="multiple"></select>' +
        ' </div>' +
